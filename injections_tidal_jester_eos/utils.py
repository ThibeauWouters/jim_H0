...
def get_lambda(mass: float,
               which: str = "jester") -> float:
    """
    Get the lambda from the mass using a specified EOS.

    Args:
        mass (float): The mass of the object

    Returns:
        float: The lambda of the object
    """
    ...
    lambda_ = np.interp(mass, likeliest_mass, likeliest_lambda)
...
def get_parser(**kwargs):
    ...
    parser.add_argument(
        "--psd-file",
        type=str,
        default="./psds/AplusDesign_psd.txt",
