...
# TODO: are there lambdas yes or no?
...
def body(args):
    ...
    # Fetch waveform used
    supported_waveforms = ["IMRPhenomD"] # , "NRTidalv2", "IMRPhenomD_NRTidalv2" # TODO:
    if args.waveform_approximant not in supported_waveforms:
        ...
        args.waveform_approximant = "IMRPhenomD"
    
    if args.waveform_approximant in ["IMRPhenomD_NRTidalv2", "NRTv2", "NRTidalv2"]:
        ripple_waveform_fn = RippleIMRPhenomD_NRTidalv2
        # reference_waveform = RippleIMRPhenomD_NRTidalv2(f_ref=20.0)
    elif args.waveform_approximant == "IMRPhenomD":
    ...
    for ifo in ifos:
        ...
        ifo.inject_signal(
            ...
            h_sky,
            detector_param,
            psd_file=args.psd_file # TODO: generalize! And use same PSD for both
        )
